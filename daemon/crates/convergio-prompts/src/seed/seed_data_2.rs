...
const MARCUS_CONTEXT_MEMORY_KEEPER: &str = include_str!("../../data/agents/marcus-context-memory-keeper.md");
...
const SENTINEL_ECOSYSTEM_GUARDIAN: &str = include_str!("../../data/agents/sentinel-ecosystem-guardian.md");
const SOCRATES_FIRST_PRINCIPLES_REASONING: &str = include_str!("../../data/agents/socrates-first-principles-reasoning.md");
const STRATEGIC_PLANNER: &str = include_str!("../../data/agents/strategic-planner.md");
const TASKMASTER_STRATEGIC_TASK_DECOMPOSITION_MASTER: &str = include_str!("../../data/agents/taskmaster-strategic-task-decomposition-master.md");
const THOR_QUALITY_ASSURANCE_GUARDIAN: &str = include_str!("../../data/agents/thor-quality-assurance-guardian.md");
const WANDA_WORKFLOW_ORCHESTRATOR: &str = include_str!("../../data/agents/wanda-workflow-orchestrator.md");
const XAVIER_COORDINATION_PATTERNS: &str = include_str!("../../data/agents/xavier-coordination-patterns.md");
...
const STEFANO_DESIGN_THINKING_FACILITATOR: &str = include_str!("../../data/agents/stefano-design-thinking-facilitator.md");
...
const DOMIK_MCKINSEY_STRATEGIC_DECISION_MAKER: &str = include_str!("../../data/agents/domik-mckinsey-strategic-decision-maker.md");
const MATTEO_STRATEGIC_BUSINESS_ARCHITECT: &str = include_str!("../../data/agents/matteo-strategic-business-architect.md");
const SATYA_BOARD_OF_DIRECTORS: &str = include_str!("../../data/agents/satya-board-of-directors.md");
const APP_RELEASE_MANAGER_EXECUTION: &str = include_str!("../../data/agents/app-release-manager-execution.md");
