		...
		<div class="lg:col-span-1 space-y-4">
			...
			{#if selectedResources.length === 0}
				<div class="text-center py-8 text-surface-500 bg-surface-50 rounded-lg">
					<svg class="w-12 h-12 mx-auto mb-2 text-surface-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
	...
	<div class="p-6 border-t border-surface-200 bg-surface-50">
		<div class="flex items-center justify-between">
			...
			<div class="flex gap-3">
				...
				>
					{#if loading}
						<svg class="w-4 h-4 animate-spin mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
